...
d3.json(data, (error, data) => {
  ...
  const legend = fixed.append("g").attrs({
    class     : "legend",
    transform : translate(20, height - 50),
  })
  ...
  legend.append("text").text("Encounters for a patient").attrs({ class : "legend-label", transform : translate(10, 16) })
  legend.append("g").attrs({ transform : translate(10, 28) }).selectAll("encounter").data([1, 3, 5, 6, 12, 15, 19, 21, 22, 23, 25, 29]).enter()
